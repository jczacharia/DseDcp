...
public abstract class SourceDocOptions<TDocument> : IConfigureElasticsearch<TDocument>
...
public static class SourceDocOptionsExtensions
{
    ...
    public static AnalysisBuilder DseAnalysis(this AnalysisBuilder analysis) =>
        analysis
    ...
    public static TextFieldBuilder DseText(this TextFieldBuilder b) =>
        b.Analyzer("iq_text_base")
    ...
    public static KeywordFieldBuilder DseKeyword(this KeywordFieldBuilder b) =>
        b.MultiField("stem", mf => mf.Text().Analyzer("iq_text_stem"))
            .MultiField("delimiter", mf => mf.Text().Analyzer("iq_text_delimiter"))
            .MultiField("exact", mf => mf.Text().Analyzer("iq_text_exact"))
            .MultiField("prefix", mf => mf.Text().Analyzer("i_prefix").SearchAnalyzer("q_prefix"))
            .MultiField("joined", mf => mf.Text().Analyzer("i_text_bigram").SearchAnalyzer("q_text_bigram"))
