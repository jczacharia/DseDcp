...
export class HlmSidebar {
  ...
  readonly sidebarWidthMobile = input<string>(this._config.sidebarWidthMobile);

  readonly side = input<'left' | 'right'>('left');
  readonly variant = input<SidebarVariant>(this._sidebarService.variant());
  ...
  readonly sidebarContainerClass = input<ClassValue>('');
