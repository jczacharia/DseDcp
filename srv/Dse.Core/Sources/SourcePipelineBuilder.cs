...
public sealed class SourcePipelineBuilder : IEndpointRouteBuilder, IEndpointConventionBuilder
{
    ...
    internal SourcePipelineBuilder(IEndpointRouteBuilder sources, SourceKey sourceKey)
    {
        SourceKey = sourceKey;
        _group = sources.MapGroup(sourceKey.Value);
    }
    ...
    public void Finally(Action<EndpointBuilder> finallyConvention) =>
        ((IEndpointConventionBuilder)_group).Finally(finallyConvention);
