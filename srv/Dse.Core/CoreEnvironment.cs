...
public static class CoreEnvironment
{
    ...
    public static readonly IReadOnlyDictionary<string, string?> AssemblyMetadata = Assembly
        .GetExecutingAssembly()
        .GetCustomAttributes<AssemblyMetadataAttribute>()
        .ToDictionary(a => a.Key, a => a.Value, StringComparer.OrdinalIgnoreCase);

    public static readonly string RepoRoot = AssemblyMetadata["RepoRoot"] ?? throw new InvalidOperationException("RepoRoot metadata is missing.");
